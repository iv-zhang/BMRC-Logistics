...
// Statpack stats merged into the unified /stats page. Kept as a redirect so
// existing links/bookmarks still resolve.
import { useEffect } from 'react';
import { useRouter } from 'next/navigation';
import { Spinner } from '@heroui/react';

export default function StatpackStatsRedirect() {
  const router = useRouter();
  useEffect(() => {
    router.replace('/stats?tab=statpacks');
  }, [router]);
  return (
